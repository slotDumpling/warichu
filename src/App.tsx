...
const BlockDisplay: FC<{
  ...
  return (
    <div className="block-display">
      <label>割注</label>
      <input type="checkbox" checked={textBlock.type === "WARICHU"} disabled />
  ...
  return (
    <div className="block-input">
      ...
      <input
        id={checkboxId}
        type="checkbox"
        checked={type === "WARICHU"}
        onChange={(e) => setType(e.target.checked ? "WARICHU" : "TEXT")}
      />
      <input
        type="text"
        value={content}
